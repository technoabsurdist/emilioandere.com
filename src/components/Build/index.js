...
export function Build() {
  ...
  const [days, setDays] = useState(initialDaysLeft);
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-no-repeat bg-center bg-cover relative" style={{ backgroundImage: "url('/static/img/build.png')" }}>
      <div className="text-center">
        ...
        <p className="text-sm md:text-2xl text-neutral-400 font-apple2mono mb-8 text-opacity-75">days till {currentYear + 1}</p>
      </div>
